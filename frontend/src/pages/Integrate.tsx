...
const API_METHODS = [
  ...
  { sig: "vouch(identifier)", desc: "Synthesize trust profile from real web data via AI consensus (fee currently disabled)", type: "write" as const },
  { sig: "refresh(identifier)", desc: "Re-evaluate with fresh web data (fee currently disabled)", type: "write" as const },
  { sig: "stake_vouch(identifier, dimension, grade)", desc: "Stake tokens endorsing a grade \u2014 slashed on dispute (stake currently disabled)", type: "write" as const },
