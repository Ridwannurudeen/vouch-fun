...
**One-liner:** Composable trust synthesis for the agentic economy — AI-graded reputation across 6 dimensions, queryable by any contract.
...
- Live data fetching via `gl.nondet.web.render()` — GitHub API + Etherscan queried at proof generation time
...
- Contract: `0xbC20d8c9A1C6ff966508f1777aeF8ef05661E847` on GenLayer Studio
- genlayer-js v0.28.2 — client, deploy, read/write contract interactions
- Vite + React/TypeScript frontend with Framer Motion
- Live data sources: GitHub REST API v3, Etherscan API
